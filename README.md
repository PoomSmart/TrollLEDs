...
2. Fix app icon not showing when built as debian package (why?)
3. Build as a debian package
4. Better error handling?
5. Refactor code (well, a lot of them were suggested by GPT/Copilot and I don't usually write an iOS app)
6. See if we can get a better app icon (I'm not a designer and the current one is evently generated by AI)
